...
def BuscarAnioAparicion(nombrePersonaje, objLista):
...
def CambiarCasaPersonaje(nombrePersonaje, casaNueva, objLista):
    indicePj = objLista.busqueda(nombrePersonaje, 'name')
    infoPJ = None
...
def MostrarCasayNombrePorFechaMenorDada(anio, objLista):
    infoPj = None
...
def MostrarCantPersonajesDeCadaCasa(conjuntoPjs, objLista):
    infoPj = None
...
def ObtenerInfoConjuntoPj(conjuntoPjs, objLista):
    infoPj = None
    mensaje = ""
...
def CambiarSuperHeroesQueTenganUnaLetraDelConjInicial(conjuntoLetras, objLista):
    infoPj = None
    mensaje = ""
...
def ejercicio6():
    ...
    print(BuscarAnioAparicion
("Wolverine", listaPersonajesMarvelYDc))

    print("\nModificar la casa del Dr.Strange")
    print(CambiarCasaPersonaje("Dr.Strange", "Marvel", listaPersonajesMarvelYDc))
    ...
    MostrarCasayNombrePorFechaMenorDada(1963, listaPersonajesMarvelYDc)

    print("\nCasa a la que pertenecen Capitana Marvel y la Mujer Maravilla")
    MostrarCantPersonajesDeCadaCasa(("Capitana Marvel", "Mujer Maravilla"), listaPersonajesMarvelYDc)

    print("\nMostrar toda informacion de Flash y Star-Lord")
    print(ObtenerInfoConjuntoPj(("Flash", "Star-Lord"), listaPersonajesMarvelYDc))

    print("\nPersonajes con inicial B, M y S")
    print CambiarSuperHeroesQueTenganUnaLetraDelConjInicial(("B", "M", "S"), listaPersonajesMarvelYDc))

    print("\nCantidad de pj en cada casa")
    cantidadPjMarvel, cantidadPjDc = ObtenerPjPorCasa(listaPersonajesMarvelYDc)
