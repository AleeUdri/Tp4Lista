...
def concatenarListasSinRepElementos(objLista1, objLista2):
    esDiferente = False
...
def contarInterseccion(objLista1, objLista2):
    esDiferente = False
...
def EliminarMostarNodosXLista(objLista):
...
def ejercicio7():
    ...
    concatenarListasSinRepElementos(objLista, objLista3)
    objLista.barrido()

    print('\nContar elementos repetidos entre dos listas')
    print('Cantidad de elementos repetidos: ', contarInterseccion(objLista, objLista4))

    print('\nEliminar y mostrar nodos de una lista')
    EliminarMostarNodosXLista(objLista)
